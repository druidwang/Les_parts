...
namespace com.Sconit.SmartDevice
{
    public partial class UCPurchaseReturn : UCBase
    {
        ...
        private static UCPurchaseReturn usPurchaseReturn;
            ...
            : base(user)
        {
            ...
            base.btnOrder.Text = "采购退货";
        }

        public static UCPurchaseReturn GetUCPurchaseReturn(User user)
        {
            if (usPurchaseReturn == null)
            {
                lock (obj)
                {
                    if (usPurchaseReturn == null)
                    {
                        usPurchaseReturn = new UCPurchaseReturn(user);
                    }
                }
            }
            usPurchaseReturn.user = user;
            usPurchaseReturn.Reset();
            return usPurchaseReturn;
        }
        ...
        protected override void ScanBarCode()
        {
            ...
            if (base.op == CodeMaster.BarCodeType.ORD.ToString())
            {
                ...
                {
                    throw new BusinessException("不是释放或执行中状态不能退货");
                }
        ...
        protected override void DoSubmit()
        {
            try
            {
                ...
                {
                    DialogResult dr = MessageBox.Show("本次退货有未发完的明细,是否继续?", "未全部退货", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
                ...
                if (this.orderMasters.Count > 1)
                {
                    ...
                    {
                        throw new BusinessException("KIT单不能合并退货。");
                    }
                    if (this.orderMasters[0].OrderDetails.Count(o => o.CurrentQty != 0) > 0)
                    {
                        throw new BusinessException("必须满足KIT单退货的退货数。");
                    }
                }
        ...
        private void MatchHu(Hu hu)
        {
            ...
            if (!base.isCancel)
            {
                ...
                //#region 再匹配允许超发的订单，未发满但是+本次退货超发了
                //if (matchedOrderDetail == null)
                //{
                ...
                //        {
                //            //有未指定制造商的订货明细
                //            throw new BusinessException("和条码{0}匹配的订单明细的退货数已经全部满足。", huId, hu.Item);
                //        }
                //        else
                //        {
                //            //没有未指定制造商的订货明细
                //            throw new BusinessException("待退货订单明细指定了制造商，而条码{0}没有指定制造商", huId);
                //        }
                //    }
                //    else
                //    {
                ...
                //        {
                //            //有未指定制造商的订货明细
                //            throw new BusinessException("和条码{0}匹配的订单明细的退货数已经全部满足。", huId);
                //        }
                //        else
                //        {
                //            //没有未指定制造商的订货明细
                //            throw new BusinessException("待退货订单明细指定的制造商和条码{0}制造商{1}不匹配", huId, hu.ManufactureParty);
                //        }
                //    }
                //}
                #endregion
        ...
        private void MergeOrderMaster(OrderMaster orderMaster)
        {
            ...
            {
                throw new BusinessException("订单类型不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("订单质量状态不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("来源组织不同不能合并退货。");
            }
            #endregion
            ...
            if (partyTo.Count() > 0)
            {
                throw new BusinessException("目的组织不同不能合并退货。");
            }
            #endregion
            ...
            if (shipFrom.Count() > 0)
            {
                throw new BusinessException("退货地址不同不能合并退货。");
            }
            #endregion
            ...
            if (shipTo.Count() > 0)
            {
                throw new BusinessException("收货地址不同不能合并退货。");
            }
            #endregion
            ...
            if (dock.Count() > 0)
            {
                throw new BusinessException("道口不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("自动收货选项不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("退货扫描条码选项不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("收货扫描条码选项不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("允许超收选项不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("收货满足包装选项不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("收货先进先出选项不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("送货单自动关闭选项不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("送货单一次性收货选项不同不能合并退货。");
            }
            #endregion
            ...
            {
                throw new BusinessException("收货创建条码选项不同不能合并退货。");
            }
            #endregion
            ...
            if (recGapTo.Count() > 0)
            {
                throw new BusinessException("收货差异调整选项不同不能合并退货。");
            }
            #endregion
