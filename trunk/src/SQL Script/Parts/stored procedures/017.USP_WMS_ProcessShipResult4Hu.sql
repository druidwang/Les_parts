	...
	begin try
		begin try
			...
			begin
				...
				if not exists(select top 1 1 from #tempMsg_017)
				begin
					insert into #tempShipPlan_017(ShipPlanId, OrderNo, OrderDetId, OrderType, Item, Uom, UnitQty, UC, OrderQty, LockQty, ShipQty, ThisShipQty, IsActive, [Version])
					select distinct bi.ShipPlanId, sp.OrderNo, sp.OrderDetId, sp.OrderType, sp.Item, sp.Uom, sp.UnitQty, sp.UC, sp.OrderQty, sp.LockQty, sp.ShipQty, 0, sp.IsActive, sp.[Version]  
