    ...
    public class TransferFlowController : WebAppBaseController
    {
        ...
        public ActionResult Import(IEnumerable<HttpPostedFileBase> flowattachments)
        {
            try
            {
                ...
                {
                    flowMgr.ImportFlow(file.InputStream, CodeMaster.OrderType.Transfer);
                }
        ...
        private string GetStringFlowInforView(IList<FlowDetail> flowDetails, bool isPercentage, bool isCss = false)
        {
            ...
            str = str.Append(Str(Resources.EXT.ControllerLan.Con_AreaFrom, true, false, l));
            str = str.Append(Str(Resources.EXT.ControllerLan.Con_AreaTo, true, false, l));
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_LocationFrom, true, false, l));
            ...
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_PickStrategy, true, false, l));
            ...
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_IsShipFifo, true, false, l));
            ...
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_IsCheckPartyFromAuth, true, false, l));
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_IsCheckPartyToAuth, true, false, l));
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_IsCreatePickList, true, false, l));
            ...
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_IsAutoStart, true, false, l));
            ...
            str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_IsRejectInspect, true, false, l));
            ...
            str = str.Append(Str(Resources.SCM.FlowDetail.FlowDetail_ContainerDescription, true, false, l));
            ...
            str = str.Append(Str(Resources.SCM.FlowDetail.FlowDetail_IsRejectInspect, true, false, l));
            str = str.Append(Str(Resources.SCM.FlowDetail.FlowDetail_IsInspect, true, false, l));
            str = str.Append(Str(Resources.SCM.FlowDetail.FlowDetail_IsChangeUnitCount, true, false, l));
            str = str.Append(Str(Resources.SCM.FlowDetail.FlowDetail_MrpWeight, true, false, l));
            str.Append("</tr>");
            foreach (var flowDetail in flowDetails)
            {
                l++;
                str = str.Append(Str(flowDetail.CurrentFlowMaster.Code, false, false, l));
                ...
                str = str.Append(Str(flowDetail.CurrentFlowMaster.LocationFrom, false, false, l));
                ...
                str = str.Append(Str(flowDetail.CurrentFlowMaster.PickStrategy, false, false, l));
                str = str.Append(Str(systemMgr.TranslateCodeDetailDescription(flowDetail.CurrentFlowMaster.HuTemplate.Replace(".xls", "")), false, false, l));
                ...
                str = str.Append(Str(flowDetail.CurrentFlowMaster.IsShipFifo, false, false, l));
                ...
                str = str.Append(Str(flowDetail.CurrentFlowMaster.IsCheckPartyFromAuthority, false, false, l));
                str = str.Append(Str(flowDetail.CurrentFlowMaster.IsCheckPartyToAuthority, false, false, l));
                str = str.Append(Str(flowDetail.CurrentFlowMaster.IsCreatePickList, false, false, l));
                ...
                str = str.Append(Str(flowDetail.CurrentFlowMaster.IsAutoStart, false, false, l));
                ...
                str = str.Append(Str(flowDetail.CurrentFlowMaster.IsRejectInspect, false, false, l));
                ...
                str = str.Append(Str(flowDetail.ContainerDescription, false, false, l));
                ...
                str = str.Append(Str(flowDetail.IsRejectInspect, false, false, l));
                str = str.Append(Str(flowDetail.IsInspect, false, false, l));
                str = str.Append(Str(flowDetail.IsChangeUnitCount, false, false, l));
