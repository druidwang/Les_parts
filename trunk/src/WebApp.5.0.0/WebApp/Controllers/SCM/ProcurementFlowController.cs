    ...
    public class ProcurementFlowController : WebAppBaseController
    {
        ...
        public ActionResult Import(IEnumerable<HttpPostedFileBase> flowattachments)
        {
            try
            {
                ...
                {
                    flowMgr.ImportFlow(file.InputStream, CodeMaster.OrderType.Procurement);
                }
        ...
        public ActionResult Export(FlowSearchModel searchModel)
        {
            ...
            return new DownloadFileActionResult(table, "ProcurementFlowDetail.xls");
         }
        #endregion
        ...
        private string GetStringFlowInforView(IList<FlowDetail>flowDetails, bool isPercentage, bool isCss = false)
            {
                ...
                str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_BillAddress, true, false, l));
                str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_PriceList, true, false, l));
                str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_BillTerm, true, false, l));
                str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_ReceiveGapTo, true, false, l));
                str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_UcDeviation, true, false, l));
                ...
                str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_IsListPrice, true, false, l));
                ...
                str = str.Append(Str(Resources.SCM.FlowMaster.FlowMaster_IsAllowProvEstRec, true, false, l));
                ...
                str = str.Append(Str(Resources.SCM.FlowDetail.FlowDetail_BillTerm, true, false, l));
                str = str.Append(Str(Resources.SCM.FlowDetail.FlowDetail_Bom, true, false, l));
                ...
                foreach (var flowDetail in flowDetails)
                {
                    ...
                    str = str.Append(Str(flowDetail.CurrentFlowMaster.BillAddress, false, false, l));
                    str = str.Append(Str(flowDetail.CurrentFlowMaster.PriceList, false, false, l));
                    str = str.Append(Str(flowDetail.CurrentFlowMaster.BillTermDescription, false, false, l));
                    str = str.Append(Str(flowDetail.CurrentFlowMaster.ReceiveGapToDescription, false, false, l));
                    str = str.Append(Str(flowDetail.CurrentFlowMaster.UcDeviation, false, false, l));
                    ...
                    str = str.Append(Str(flowDetail.CurrentFlowMaster.IsListPrice, false, false, l));
                    ...
                    str = str.Append(Str(flowDetail.CurrentFlowMaster.IsAllowProvEstRec, false, false, l));
                    ...
                    str = str.Append(Str(flowDetail.BillTerm, false, false, l));
                    str = str.Append(Str(flowDetail.Bom, false, false, l));
