...
IF EXISTS(SELECT * FROM sys.objects WHERE type='P' AND name='USP_CONVERT_UOM') 
     DROP PROCEDURE [USP_CONVERT_UOM] 
GO

CREATE PROCEDURE [dbo].[USP_CONVERT_UOM] 
(
	@PT_NO VARCHAR(20),
	@SRC_UOM VARCHAR(3),
	@TRG_UOM VARCHAR(3),
	@SRC_QTY DECIMAL(18, 8),
	@TRG_QTY DECIMAL(18, 8) out
) --WITH ENCRYPTION
AS 
BEGIN
	SET NOCOUNT ON
